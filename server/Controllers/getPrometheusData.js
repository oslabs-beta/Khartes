...
var getPrometheusData = function (podName, query, nodeName) { return __awaiter(void 0, void 0, void 0, function () {
    var podOrNode, queryResult, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios.get("http://localhost:1337/api/v1/query?query=".concat(query, "{").concat(podOrNode, "=\"").concat(podName, "\"}"))
            ...
            case 2:
                ...
                //console.log(queryResult);
                //console.log(queryResult.data.result[0].value)
                return [2 /*return*/, queryResult.data.data.result[0].value];
            case 3:
                _a = _b.sent();
...
//     }
//   }
exports["default"] = getPrometheusData;
