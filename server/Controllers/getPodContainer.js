...
var getPodContainer = function (podname) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, stdout, stderr, yamls, containerYaml;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log('doing getPodContainer');
                return [4 /*yield*/, exec("kubectl get pod ".concat(podname, " -o yaml"))];
            case 1:
                _a = _b.sent(), stdout = _a.stdout, stderr = _a.stderr;
                yamls = YAML.parse(stdout);
                containerYaml = yamls.spec.containers;
                return [2 /*return*/, YAML.stringify(containerYaml)];
        }
    });
}); };
//console.log(getPodContainer('deployment-memoryuser-564878964b-8kvtg'));
exports["default"] = getPodContainer;
