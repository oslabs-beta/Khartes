...
var getPods = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, stdout, stderr, yamls, arrPodsNodes;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log('doing getPods');
                return [4 /*yield*/, exec('kubectl get pods -o yaml')];
            case 1:
                _a = _b.sent(), stdout = _a.stdout, stderr = _a.stderr;
                yamls = YAML.parse(stdout).items;
                arrPodsNodes = [];
                yamls.forEach(function (el) {
                    var name = el.metadata.name;
                    var node = el.spec.nodeName;
                    var obj = { pod: name, node: node };
                    arrPodsNodes.push(obj);
                });
                return [2 /*return*/, arrPodsNodes];
        }
    });
}); };
