...
exports.startPortForward = void 0;
...
//turn it into a yaml
var startPortForward = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, stdout, stderr, allPodsYamlObject, namespace, podName, i;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log('Are we going into starPortForward function? Yes?');
                return [4 /*yield*/, exec('kubectl get pods -A -o yaml')];
            case 1:
                _a = _b.sent(), stdout = _a.stdout, stderr = _a.stderr;
                allPodsYamlObject = YAML.parse(stdout);
                namespace = '';
                podName = '';
                for (i = 0; i < allPodsYamlObject.items.length; i++) {
